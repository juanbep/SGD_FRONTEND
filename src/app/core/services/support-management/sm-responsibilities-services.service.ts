...
export class SmResponsibilitiesServicesService {
  ...
  getResponsibilities(
  ...
  ): Observable<SimpleResponse<PagedResponse<ResponsabilidadResponse>>> {
    ...
    return this.httpClient.get<
      SimpleResponse<PagedResponse<ResponsabilidadResponse>>
    >(`${this.baseUrl}/api/actividades/buscarActividadesPorEvaluador`, {
      params,
    });
  }
  ...
  getInfoResponsibilityByForm(
    idSource: number
  ): Observable<SimpleResponse<FuenteEstudianteFormularioResponse>> {
    return this.httpClient.get<
      SimpleResponse<FuenteEstudianteFormularioResponse>
    >(`${this.baseUrl}/api/evaluacion-estudiante/fuente/${idSource}`);
  }
   ...
   */
  getInforResponsibilityByFormCoordinator(
    idSource: number
  ): Observable<SimpleResponse<FuenteCoordinadorFormularioResponse>> {
    return this.httpClient.get<
      SimpleResponse<FuenteCoordinadorFormularioResponse>
    >(`${this.baseUrl}/api/informes-administracion/fuente/${idSource}`);
  }
  ...
  saveResponibilityFormStundent(
    ...
    return this.httpClient.post(
      `${this.baseUrl}/api/evaluacion-estudiante`,
      formData,
      { responseType: 'text' }
    );
  }
   ...
   */
  saveResponsibilityFormCoordinator(
    fuenteCoordinadorFormulario: FuenteCoordinadorFormulario,
    reportDocument: File
  ): Observable<any> {
    const formData = new FormData();
    ...
    return this.httpClient.post(
      `${this.baseUrl}/api/informes-administracion`,
      formData,
      { responseType: 'text' }
    );
  }
