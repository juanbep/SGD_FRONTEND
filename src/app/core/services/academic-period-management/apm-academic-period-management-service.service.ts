...
export class ApmAcademicPeriodManagementService {
  ...
  saveNewAcademicPeriod(
    newAcademicPeriod: PeriodoAcademicoCreate
  ): Observable<SimpleResponse<PeriodoAcademicoResponse>> {
    return this.httpClient.post<SimpleResponse<PeriodoAcademicoResponse>>(
      `${this.baseUrl}/api/periodos-academicos`,
      newAcademicPeriod
    );
  }
  ...
  getAllAcademicPeriods(
    page: number | null,
    size: number | null
  ): Observable<SimpleResponse<PagedResponse<PeriodoAcademicoResponse>>> {
    let params = new HttpParams()
      .set('page', page ? page.toString() : '')
      .set('size', size ? size.toString() : '');
    return this.httpClient.get<
      SimpleResponse<PagedResponse<PeriodoAcademicoResponse>>
    >(`${this.baseUrl}/api/periodos-academicos`, { params });
  }
   ...
   * */
  editAcademicPeriod(
    oidAcademicPeriod: number,
    academicPeriod: PeriodoAcademicoCreate
  ): Observable<SimpleResponse<any>> {
    return this.httpClient.put<SimpleResponse<any>>(
      `${this.baseUrl}/api/periodos-academicos/${oidAcademicPeriod}`,
      academicPeriod,
      { responseType: 'json' }
    );
  }
  ...
  activeAcademicPeriod(): Observable<SimpleResponse<PeriodoAcademicoResponse>> {
    return this.httpClient.get<SimpleResponse<PeriodoAcademicoResponse>>(
      `${this.baseUrl}/api/periodos-academicos/activo`
    );
  }
  ...
  loadInfoTechersAndActivities(idPeriodo: string) {
    ...
    return this.httpClient.post<SimpleResponse<any>>(
      `${this.baseUrlLaborDocente}/api/labor-docente`,
      params,
      { responseType: 'json' }
    );
  }

  getAcademicPeriodsByKira(): Observable<
    SimpleResponse<PeriodoAcademicoKiraResponse[]>
  > {
    return this.httpClient.get<SimpleResponse<PeriodoAcademicoKiraResponse[]>>(
      `${this.baseUrl}/api/periodos-academicos/kira`,
      { responseType: 'json' }
    );
  }
}
