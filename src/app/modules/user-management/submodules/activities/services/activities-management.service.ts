...
export class ActivitiesManagementService {
  ...
  private usersSignal: WritableSignal<PagedResponse<UsuarioResponse> | null> =
    signal(null);
  private activitiesSignal: WritableSignal<PagedResponse<ActividadResponse> | null> =
    signal(null);

  private paramsUsersFilterSignal: WritableSignal<{
   ...
   * */
  setParamsActivitiesFilter(newData: {
    nameActivity: string | null;
    typeActivity: string | null;
    activityCode: string | null;
    administrativeCode: string | null;
  ...
  getActivitiesByUser(page: number, size: number, idUser: number) {
    return this.umActivitiesServiceService.getActivitiesByUser(
      page,
      size,
      idUser
    );
  ...
  getActivitiesByParams(
    ...
    return this.umActivitiesServiceService.getActivitiesByParams(
      page,
      size,
      idEvaluated,
      nameActivity,
