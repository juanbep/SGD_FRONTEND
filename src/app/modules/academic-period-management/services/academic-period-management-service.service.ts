...
export class AcademicPeriodManagementService {
  private academicPeriods: WritableSignal<PagedResponse<PeriodoAcademicoResponse> | null> =
    signal(null);
  ...
  private _currentAcademicPeriod = signal<PeriodoAcademicoResponse | null>(
    null
  );
  ...
  set currentAcademicPeriodValue(
    academicPeriod: PeriodoAcademicoResponse | null
  ) {
  ...
  saveNewAcademicPeriod(newAcademicPeriod: PeriodoAcademicoCreate) {
    return this.apmAcademicPeriodManagementService.saveNewAcademicPeriod(
      newAcademicPeriod
    );
  }
  ...
  editAcademicPeriod(
    ...
    return this.apmAcademicPeriodManagementService.editAcademicPeriod(
      oidAcademicPeriod,
      academicPeriod
    );
  }
  ...
  loadInfoTechersAndActivities(idPeriodo: string) {
    return this.apmAcademicPeriodManagementService.loadInfoTechersAndActivities(
      idPeriodo
    );
  }
