...
export class StatisticsService {
  statisticsManagementServicesService = inject(
    StatisticsManagementServicesService
  );
  umUserManagementService = inject(UmUsersServicesService);
  apmAcademicPeriodManagementService = inject(
  ...
  getActivityEvaluationComparison(
    ...
    return this.statisticsManagementServicesService.getActivityEvaluationComparison(
      idUser,
      academicPeriodId,
      activityTypeId
    );
  ...
  getAverageEvaluationByDepartment(academicPeriodId: number) {
    return this.statisticsManagementServicesService.getAverageEvaluationDepartment(
      academicPeriodId
    );
  }
  ...
  getUserByParams(
    ...
    return this.umUserManagementService.getAllUsersByParams(
      page,
      totalPage,
      userId,
      userName,
  ...
  getEvolutionAverageEvaluationDepartment(
    ...
    return this.statisticsManagementServicesService.getEvolutionAvarageEvaluationDepartment(
      academicPeriodsId,
      departmentsId
    );
  }
  ...
  getStatisticsQuestions(
    ...
    return this.statisticsManagementServicesService.getStatisticsQuestions(
      academicPeriodsId,
      departmentsId,
      activitiesTypeId
    );
  ...
  getRankingTeacher(academicPeriodId: string, departmentId: string) {
    return this.statisticsManagementServicesService.rankingTeacher(
      academicPeriodId,
      departmentId
    );
  }
