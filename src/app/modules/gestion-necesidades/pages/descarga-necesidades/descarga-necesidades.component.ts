...
import { ModalDescargaNecesidadesComponent } from '../../components/modal-descarga-necesidades/modal-descarga-necesidades.component';

@Component({
  selector: 'app-descarga-necesidades',
  standalone: true,
  imports: [CommonModule, ModalDescargaNecesidadesComponent],
  templateUrl: './descarga-necesidades.component.html',
  styleUrl: './descarga-necesidades.component.css',
})
export class DescargaNecesidadesComponent implements OnInit {
