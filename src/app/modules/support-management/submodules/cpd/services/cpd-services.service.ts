...
export class CpdServicesService {
    ...
    getTeachersByDepartment(page: number, totalPage: number, department: string, userId:string | null, userName:string | null, category:string | null, rol:string | null){
        return this.umUsersServicesService.getAllUsersByParams(page, totalPage, userId , userName, null, department, category, null, null, null, rol, null);
    }

    getActivities(page: number, totalPage:number, idUser:number, activityName:string | null, activityType:string | null){
        return this.smActivitiesServicesService.getActivities(idUser, activityName, activityType, null, null, page, totalPage);
    }
    ...
    downloadFiles(period: string, department: string, contractType:string | null, idUser:number| null, esConsolidado: boolean | null){
