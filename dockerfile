...
# Construimos la aplicación Angular en modo de producción, especificando el base-href y deploy-url para que coincidan con la ruta /sed-front/.
...
# Copiamos el archivo de configuración de Nginx al contenedor para personalizar el comportamiento del servidor.
COPY ./nginx.conf /etc/nginx/conf.d/default.conf

# Copiamos los archivos generados en la etapa de construcción al directorio donde Nginx sirve los archivos estáticos, dentro de /sed-front.
